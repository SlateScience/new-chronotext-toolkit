...
namespace chr
{
    ...
    template<typename T> T loadString(chr::InputSource::Ref source);
    template<typename T> std::vector<T> readLines(chr::InputSource::Ref source);
    
    std::vector<std::string> readInstructions(chr::InputSource::Ref source);
