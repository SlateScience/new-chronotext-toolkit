...
void Java_org_chronotext_cinder_CinderRenderer_setup(JNIEnv *env, jobject obj, jfloat density, jint width, jint height, jint displayRotation)
{
    gDelegate->setup(density, width, height, displayRotation);
}
