...
extern "C"
{
    ...
    void Java_org_chronotext_cinder_CinderRenderer_setup(JNIEnv *env, jobject obj, jint dpi, jint width, jint height, jint accelerometerRotation);
...
void Java_org_chronotext_cinder_CinderRenderer_setup(JNIEnv *env, jobject obj, jint dpi, jint width, jint height, jint accelerometerRotation)
{
    gDelegate->setup(dpi, width, height, accelerometerRotation);
}
